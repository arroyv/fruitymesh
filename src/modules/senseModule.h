...
//     NodeId partner4;
//     i8 rssi4;
// } senseModuleConnectionsMessage;
// STATIC_ASSERT_SIZE(senseModuleConnectionsMessage, 12);
// #pragma pack(pop)

// #pragma pack(push)
// #pragma pack(1)
// struct senseModuleConnectionsVerboseRequestMessage
// {
//     u32 connectionIndex;
// };
// STATIC_ASSERT_SIZE(senseModuleConnectionsVerboseRequestMessage, 4);
// struct senseModuleConnectionsVerboseHeader
// {
//     constexpr static u32 MAX_KNOWN_VERSION = 1;
//     u32 version;
//     u32 connectionIndex;
// };
// STATIC_ASSERT_SIZE(senseModuleConnectionsVerboseHeader, 8);
// struct senseModuleConnectionsVerboseConnection
// {
//     NodeId                partnerId;
...
// };
// STATIC_ASSERT_SIZE(senseModuleConnectionsVerboseConnection, 54);
// struct senseModuleConnectionsVerboseMessage
// {
//     constexpr static u32 SIZEOF_MAX_KNOWN_VERSION = 62;
//     senseModuleConnectionsVerboseHeader header;
//     senseModuleConnectionsVerboseConnection connection;
// };
// STATIC_ASSERT_SIZE(senseModuleConnectionsVerboseMessage, 62);

// struct senseModuleKeepAliveMessage
// {
//     u8 fromSink : 1;
//     u8 reserved : 7;
// };
// STATIC_ASSERT_SIZE(senseModuleKeepAliveMessage, 1);
// #pragma pack(pop)

/*
 * The senseModule can respond to a number of requests for device info
...
public:
        ...
        static constexpr u32 batteryMeasurementIntervalDs = SEC_TO_DS(6);
        ...
        // enum class senseModuleGeneralMessages : u8
        // {
        //     LIVE_REPORT = 1
        // };
...
private:
        ...
        typedef struct
            ...
            // static constexpr int SIZEOF_SENSE_MODULE_DEVICE_INFO_V2_MESSAGE = (37);
            // typedef struct
            // {
            //     u16 manufacturerId;
            ...
            // } senseModuleDeviceInfoV2Message;
            // STATIC_ASSERT_SIZE(senseModuleDeviceInfoV2Message, 37);

            //This message delivers often changing information and info about the incoming connection
            static constexpr int SIZEOF_SENSE_MODULE_STATUS_MESSAGE = 1; //TODO CHANGE THIS NUMBER
            typedef struct
            {
            ...
            //     u32 extra;
            //     u32 extra2;
            // } senseModuleLiveReportMessage;
            // STATIC_ASSERT_SIZE(senseModuleLiveReportMessage, 9);
